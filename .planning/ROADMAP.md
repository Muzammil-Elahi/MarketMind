...
- [x] 04-03-PLAN.md — Walk-forward fold generator (TimeSeriesSplit) + shared backtest metrics module
- [x] 04-04-PLAN.md — SMA baseline model + XGBoost direct-horizon quantile model
- [x] 04-05-PLAN.md — Prophet model, import-guarded
...
- [x] 04-08-PLAN.md — Search page: model/horizon controls, Generate Forecast, forecast+backtest rendering (D-01-D-05/D-07/D-08)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04-09-PLAN.md — Search page: Compare All Models — dialog + persistent banner + toast + 3-column view (D-06)
...
| 4. Multi-Model Prediction + Walk-Forward Backtesting | 9/9 | In Progress|  |
